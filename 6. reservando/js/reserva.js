...
Reserva.prototype.precioFinal = function() {
    ...
    let adicional = this.adicionales(precioBase);
    let descuento = this.descuentos(precioBase);
...
Reserva.prototype.adicionalFinDeSemana = function(base) {
    let diaSemana = this.horario.getUTCDay();
...
Reserva.prototype.adicionalHorario = function(base) {
    let minutos = (this.horario.getHours() * 60) + this.horario.getMinutes();
